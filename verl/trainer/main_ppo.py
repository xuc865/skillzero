...
class TaskRunner:
    def run(self, config):
        ...
        envs, val_envs, curriculum_manager, test_envs = make_envs(config)
        ...
        reward_fn = reward_manager_cls(tokenizer=tokenizer, num_examine=1, normalize_by_length=False, **reward_manager_kwargs)
