...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        internalized = self.curriculum_manager.get_internalized_skill_names()
        metric_dict['val/curriculum/internalized_skill_count'] = len(internalized)
        metric_dict['val/curriculum/internalized_skills'] = ','.join(internalized)
        metric_dict['val/curriculum/general_skills_omitted'] = float(
            'general_skills' in internalized
        )
