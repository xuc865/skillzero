...
# Optional curriculum: omit general_skills from train/val prompt when mean val delta is tiny (same 2 val passes).
#   env.curriculum_learning.skill_internalize.enable=True
#   env.curriculum_learning.max_set_min_floor=1
